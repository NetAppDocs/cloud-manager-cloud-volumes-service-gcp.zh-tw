$(document).ready(function () {
  try {
    ...
    let baseUrlSection = "/zh-tw/cloud-manager-cloud-volumes-service-gcp/pdfs/";
    ...
    zipFilename = zipFilename !== ''?zipFilename:"cloud-manager-cloud-volumes-service-gcp.zh-tw.zip";
